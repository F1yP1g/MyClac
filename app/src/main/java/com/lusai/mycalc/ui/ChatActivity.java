...
import com.lusai.mycalc.MainActivity;
import com.lusai.mycalc.R;
import com.lusai.mycalc.adapter.ChatMessageAdapter;
import com.lusai.mycalc.bean.ChatMessage;
import com.lusai.mycalc.bean.ChatMessage.Type;
import com.lusai.mycalc.tools.HttpUtils;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        list.add(new ChatMessage("你好呀小主人", Type.INCOUNT, new Date()));
    ...
    private void chat() {
        ...
        if (TextUtils.isEmpty(send_message)) {
            Toast.makeText(ChatActivity.this, "不能发送空消息哦",
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_DOWN) {
            ...
            if (secondTime - firstTime > 2000) {
                Toast.makeText(ChatActivity.this, "再按一次返回退出聊天", Toast.LENGTH_SHORT).show();
